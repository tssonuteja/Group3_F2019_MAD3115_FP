...
class AddEmployeeViewController: UIViewController, CLLocationManagerDelegate {
    ...
    override func viewDidLoad() {
        ...
        func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
           ...
           func showLocationDisabledPopUp() {
               let alertController = UIAlertController(title: "Background Location Access Disabled", message: "In order to deliver pizza we need your location",
